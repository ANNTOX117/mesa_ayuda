<div id="sideNavigation" class="sidenav">
  ...
  <a href="<?php echo base_url();?>reporteador/principal">Todas las dudas</a>

  <a href="#">Tikets</a>
  <ul>
    <a href="<?php echo base_url();?>reporteador/principal/ticket_abierto"><li>Abiertos <?php if(isset($abiertos)) { echo '('.$abiertos.')'; } ?></li></a>
    <a href="<?php echo base_url();?>reporteador/principal/ticket_asignado"><li>Asignados <?php if(isset($asignados)) { echo '('.$asignados.')'; } ?> </li></a> 
    <a href="<?php echo base_url();?>reporteador/principal/ticket_pendiente"><li>Pendientes <?php if(isset($pendientes)) { echo '('.$pendientes.')'; } ?></li></a>
    <a href="<?php echo base_url();?>reporteador/principal/ticket_resuelto"><li>Resueltos <?php if(isset($resueltos)) { echo '('.$resueltos.')'; } ?></li></a>
    <a href="<?php echo base_url();?>reporteador/principal/ticket_cerrado"><li>Cerrados <?php if(isset($cerrados)) { echo '('.$cerrados.')'; } ?></li></a>
  </ul>


  <a href="<?php echo base_url();?>reporteador/principal/logout">Cerrar sesión</a>
</div>
                        ...
                        <tbody>
                               ...
                               if(isset($dudas)){
                                foreach ($dudas as $key => $fila) {
                                    ...
                                    echo '<form method="GET" action='.base_url().'reporteador/principal/responder>';
